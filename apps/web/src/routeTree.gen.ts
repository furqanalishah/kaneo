...
import { Route as LayoutAuthenticatedDashboardWorkspaceWorkspaceIdPagesIndexRouteImport } from './routes/_layout/_authenticated/dashboard/workspace/$workspaceId/pages/index'
import { Route as LayoutAuthenticatedDashboardWorkspaceWorkspaceIdPagesPageIdRouteImport } from './routes/_layout/_authenticated/dashboard/workspace/$workspaceId/pages/$pageId'
...
const LayoutAuthenticatedDashboardWorkspaceWorkspaceIdPagesIndexRoute =
  LayoutAuthenticatedDashboardWorkspaceWorkspaceIdPagesIndexRouteImport.update({
    id: '/pages/',
    path: '/pages/',
    getParentRoute: () => LayoutAuthenticatedDashboardWorkspaceWorkspaceIdRoute,
  } as any)
const LayoutAuthenticatedDashboardWorkspaceWorkspaceIdPagesPageIdRoute =
  LayoutAuthenticatedDashboardWorkspaceWorkspaceIdPagesPageIdRouteImport.update(
    {
      id: '/pages/$pageId',
      path: '/pages/$pageId',
      getParentRoute: () =>
...
export interface FileRoutesByFullPath {
  ...
  '/dashboard/workspace/$workspaceId/pages/$pageId': typeof LayoutAuthenticatedDashboardWorkspaceWorkspaceIdPagesPageIdRoute
  '/dashboard/workspace/$workspaceId/pages/': typeof LayoutAuthenticatedDashboardWorkspaceWorkspaceIdPagesIndexRoute
...
export interface FileRoutesById {
  ...
  '/_layout/_authenticated/dashboard/workspace/$workspaceId/pages/$pageId': typeof LayoutAuthenticatedDashboardWorkspaceWorkspaceIdPagesPageIdRoute
  '/_layout/_authenticated/dashboard/workspace/$workspaceId/pages/': typeof LayoutAuthenticatedDashboardWorkspaceWorkspaceIdPagesIndexRoute
...
export interface FileRouteTypes {
  ...
  fullPaths:
    ...
    | '/dashboard/workspace/$workspaceId/pages/$pageId'
    | '/dashboard/workspace/$workspaceId/pages/'
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_layout/_authenticated/dashboard/workspace/$workspaceId/pages/': {
      id: '/_layout/_authenticated/dashboard/workspace/$workspaceId/pages/'
      path: '/pages'
      fullPath: '/dashboard/workspace/$workspaceId/pages/'
      preLoaderRoute: typeof LayoutAuthenticatedDashboardWorkspaceWorkspaceIdPagesIndexRouteImport
      parentRoute: typeof LayoutAuthenticatedDashboardWorkspaceWorkspaceIdRoute
    }
    '/_layout/_authenticated/dashboard/workspace/$workspaceId/pages/$pageId': {
      id: '/_layout/_authenticated/dashboard/workspace/$workspaceId/pages/$pageId'
      path: '/pages/$pageId'
      fullPath: '/dashboard/workspace/$workspaceId/pages/$pageId'
      preLoaderRoute: typeof LayoutAuthenticatedDashboardWorkspaceWorkspaceIdPagesPageIdRouteImport
      parentRoute: typeof LayoutAuthenticatedDashboardWorkspaceWorkspaceIdRoute
    }
    '/_layout/_authenticated/dashboard/workspace/$workspaceId/project/$projectId/': {
...
interface LayoutAuthenticatedDashboardWorkspaceWorkspaceIdRouteChildren {
  ...
  LayoutAuthenticatedDashboardWorkspaceWorkspaceIdPagesPageIdRoute: typeof LayoutAuthenticatedDashboardWorkspaceWorkspaceIdPagesPageIdRoute
  LayoutAuthenticatedDashboardWorkspaceWorkspaceIdPagesIndexRoute: typeof LayoutAuthenticatedDashboardWorkspaceWorkspaceIdPagesIndexRoute
...
const LayoutAuthenticatedDashboardWorkspaceWorkspaceIdRouteChildren: LayoutAuthenticatedDashboardWorkspaceWorkspaceIdRouteChildren =
  {
    ...
    LayoutAuthenticatedDashboardWorkspaceWorkspaceIdIndexRoute:
      LayoutAuthenticatedDashboardWorkspaceWorkspaceIdIndexRoute,
    LayoutAuthenticatedDashboardWorkspaceWorkspaceIdPagesPageIdRoute:
      LayoutAuthenticatedDashboardWorkspaceWorkspaceIdPagesPageIdRoute,
    LayoutAuthenticatedDashboardWorkspaceWorkspaceIdPagesIndexRoute:
      LayoutAuthenticatedDashboardWorkspaceWorkspaceIdPagesIndexRoute,
